export const enterpriseCorpus = {
    ...
    sections: [
        ...
        },
        {
            ...
            content: "Full-time staff receive 20 annual leave days per fiscal year. " +
        ...
        },
        {
            ...
            content: "Employees approved for telecommuting may work remotely up to three days per calendar week. " +
        ...
        },
        {
            ...
            content: "All engineers and staff must enforce hardware token multi-factor authentication (MFA). " +
        ...
        },
        {
            ...
            content: "Effective January 2026, the domestic business travel per-diem allowance is updated to $95 per day. " +
...
export function chunkCorpus(document, maxCharacters = 250) {
    const chunks = [];
    let chunkIndex = 0;
...
function splitContent(content, maxCharacters) {
