...
import { LLMInvalidJSONError, LLMSchemaValidationError } from "../src/llm/errors.js";
...
async function testStructuredOutputHardening() {
    ...
    total++;
    try {
        const res = await parseStructuredOutput(JSON.stringify({ name: "Alice", email: "alice@example.com", company: "Acme" }), LeadSchema);
