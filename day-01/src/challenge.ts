...
import type { LLMProvider } from "./llm/providers/base.provider.js";
 ...
 */
class ChaoticPrimaryProvider implements LLMProvider {
  readonly name = "chaotic-primary";
  private callCount = 0;
 ...
 */
class ResilientBackupProvider implements LLMProvider {
  readonly name = "resilient-backup";
  private callCount = 0;
